...
![Reference Image](/Images/screenshot_schema.png)
...
- Посмотреть итоговый дашборд можно [здесь](http://45.153.68.237:8088/superset/dashboard/21/)
...
Разработан наглядный [дашборд](http://45.153.68.237:8088/superset/dashboard/21/) для анализа популярных треков и рекомендаций
